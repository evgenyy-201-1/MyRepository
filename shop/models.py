...
class Product(models.Model):
    ...
    notice = models.TextField(blank=True, verbose_name='Примечание к товару')
    country = models.CharField(max_length=70, verbose_name='Регион')
    director = models.CharField(max_length=70, verbose_name='Поставщик')
...
class Order(models.Model):
    ...
    display_amount.short_description = 'Цена'
